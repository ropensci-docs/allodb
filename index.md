# ![](https://i.imgur.com/39pvr4n.png) allodb: An R package for biomass estimation at extratropical forest plots
...
individual tree *dry* biomass were retrieved, checked, and combined
using a weighting function designed to ensure optimal equation selection
over the full tree size range with smooth transitions across equations.
The equation dataset used can be customized with built-in functions that
...
This new equation table should be provided as an argument in the
...
![](reference/figures/README-resample-acer-1.png)

The resampled values are then used to fit the following nonlinear model:
![](https://render.githubusercontent.com/render/math?math=AGB%20=%20a%20*%20dbh%20%5E%20b%20%2B%20e),
with i.i.d.
![](https://render.githubusercontent.com/render/math?math=e%20~N(0,%20sigma%5E2)).
...
![](reference/figures/README-est-params-acer-1.png)
